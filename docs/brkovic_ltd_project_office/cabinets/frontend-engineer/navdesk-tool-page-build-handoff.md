...
Если инструмент открывается как отдельная рабочая страница и в runtime скрывает
визуальный site header/footer, внутри рабочей области обязательно оставить
скромную текстовую ссылку:

```text
brkovic.ltd - NavDesk instruments
```

Правило ссылки: вести на локализованный `navdesk.html` в новом окне/вкладке.
Это не кнопка и не навигационная панель, а тихая принадлежность к NavDesk и
путь обратно к общему штурманскому столу.
